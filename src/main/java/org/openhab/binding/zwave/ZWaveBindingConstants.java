...
public class ZWaveBindingConstants {
    ...
    // Security keys
    public final static String CONFIGURATION_NETWORKKEY_S2_ACCESS = "security_networkkey_s2_access";
    public final static String CONFIGURATION_NETWORKKEY_S2_AUTH = "security_networkkey_s2_auth";
    public final static String CONFIGURATION_NETWORKKEY_S2_UNAUTH = "security_networkkey_s2_unauth";
