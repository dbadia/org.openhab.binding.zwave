 ...
 *
 * @see ZWaveSecurity2CryptoOperations
 * @author Dave Badia
 *
 */
abstract class ZWaveSecurity2CryptoProvider {
     ...
     * @throws ZWaveSecurity2CryptoException if an error occurs during the operation
     */
     ...
     * @throws ZWaveSecurity2CryptoException if an error occurs during the operation
     */
    protected abstract SecureRandom buildEntrophySourceAccordingToZwaveSpec() throws ZWaveSecurity2CryptoException;
     ...
     * @throws ZWaveSecurity2CryptoException if an error occurs during the creation
     */
