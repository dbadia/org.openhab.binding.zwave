    ...
    private static byte[] waitForHardwareBaseEntropy(InitStopWatch stopWatch) {
        ...
        if (hardwareRngCoordinator.isSupportsRandom()) {
            try {
                ...
                logger.debug("waitForHardwareBaseEntropy returning controller generated bytes");
                return randomBytes;
                ...
                logger.debug(
                        "SPEC_VIOLATION: waitForHardwareBaseEntropy: controller does not support GET_RANDOM, failing back to SecureRandom",
                        e);
            }
        }
    ...
    public static ZWaveCryptoOperations getCryptoProvider() {
        synchronized (initLock) {
            ...
            while (instance == null) { // per Java Concurrency in Practice by Brian Goetz
                ...
                // TODO: give up after a cert time?
            }
            return instance;
        }
    }
