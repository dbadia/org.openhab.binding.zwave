...
// TODO: rename X25519KeyAgreement
public interface ZWaveCryptoDiffieHellman {
     ...
     * </ul>
     *
     * @param secureRandom TODO: DB zDoc
     *
     ...
     * @throws ZWaveCryptoException
     */
    public abstract byte[] executeDiffieHellmanKeyAgreement(PrivateKey privateKey, byte[] deviceEcdhPublicKeyBytes,
            SecureRandom entrophySource) throws ZWaveCryptoException;

    public abstract byte[] extractPublicKeyBytes(KeyPair keyPair);
}
